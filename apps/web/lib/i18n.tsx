...
const dict = {
  ...
  home: {
    greetingMorning: { en: "Good morning", ja: "おはようございます" },
    greetingAfternoon: { en: "Good afternoon", ja: "こんにちは" },
    greetingEvening: { en: "Good evening", ja: "こんばんは" },
    signInPrompt: { en: "Sign in to see your dashboard.", ja: "ダッシュボードを見るにはログインしてください。" },
    streakHeading: { en: "Streak", ja: "連続出席" },
    streakDays: { en: "{count}-day streak", ja: "{count}日連続" },
    streakNone: { en: "No streak yet", ja: "まだ連続記録なし" },
    streakNoneHint: { en: "Check in to a classroom session to start one.", ja: "クラスのセッションにチェックインすると記録が始まります。" },
    nextEventHeading: { en: "Next up", ja: "次の予定" },
    nextEventNone: { en: "Nothing on your calendar", ja: "予定はありません" },
    nextEventNoneHint: { en: "Browse events to find something to join.", ja: "参加できるイベントを探してみましょう。" },
    checkInWindowOpen: { en: "Check-in is open", ja: "チェックイン受付中" },
    ...
    sessionLive: { en: "Session in progress", ja: "セッション進行中" },
    sessionIdle: { en: "No session running", ja: "セッションは停止中" },
    sessionIdleHint: { en: "Open a session so students can check in.", ja: "セッションを開始すると学生がチェックインできます。" },
    checkedIn: { en: "Checked in", ja: "チェックイン済み" },
    runningFor: { en: "Running {duration}", ja: "経過 {duration}" },
    lastSessionOn: { en: "Last session {date}", ja: "前回 {date}" },
    noSessionsYet: { en: "No sessions recorded yet", ja: "セッション記録はまだありません" },
    attendanceMap: { en: "Attendance map", ja: "出席マップ" },
    mapCurrent: { en: "Current", ja: "現在" },
    mapLongest: { en: "Longest", ja: "最長" },
    mapSessions: { en: "Sessions", ja: "回数" },
    mapLess: { en: "Less", ja: "少" },
    mapMore: { en: "More", ja: "多" },
    topStreaks: { en: "Top streaks", ja: "連続出席ランキング" },
    noStudentsYet: { en: "No students yet", ja: "学生がまだいません" },
    joinCodeLabel: { en: "Class join code", ja: "クラス参加コード" },
    copied: { en: "Copied", ja: "コピーしました" },
    copy: { en: "Copy", ja: "コピー" },
    sessionsLabel: { en: "Sessions", ja: "セッション" },
    avgRateLabel: { en: "Avg rate", ja: "平均出席率" },
    upcomingHeading: { en: "Upcoming", ja: "今後の予定" },
    orgEventsHeading: { en: "Recent events", ja: "最近のイベント" },
    otherClassesHeading: { en: "Other classes", ja: "その他のクラス" },
    dayStreakLabel: { en: "Day streak", ja: "連続日数" },
    viewAll: { en: "View all", ja: "すべて見る" },
    noOneYet: { en: "Nobody has checked in yet", ja: "まだ誰もチェックインしていません" },
  },
  dashboard: {
  ...
  orgMembers: {
    ...
    emailPlaceholder: { en: "teammate@example.com", ja: "teammate@example.com" },
    invite: { en: "Invite", ja: "招待" },
    inviteError: { en: "Failed to invite member — check the email is registered", ja: "招待に失敗しました。メールアドレスが登録済みか確認してください" },
  ...
  verifyEmail: {
    verifying: { en: "Verifying your email…", ja: "メールアドレスを確認しています…" },
    successTitle: { en: "Email verified", ja: "メールアドレスを確認しました" },
    successDescription: { en: "Your email address is now confirmed.", ja: "メールアドレスの確認が完了しました。" },
    goToDashboard: { en: "Go to dashboard", ja: "ダッシュボードへ" },
    errorTitle: { en: "Couldn't verify", ja: "確認できませんでした" },
    noTokenDescription: { en: "This link is missing its token — request a new one from your account settings.", ja: "このリンクにはトークンが含まれていません。アカウント設定から新しいリンクをリクエストしてください。" },
    genericError: { en: "This verification link is invalid or has expired.", ja: "この確認リンクは無効か期限切れです。" },
    bannerMessage: { en: "Please verify your email address.", ja: "メールアドレスを確認してください。" },
    bannerSent: { en: "Verification email sent — check your inbox.", ja: "確認メールを送信しました。受信箱をご確認ください。" },
    resendLink: { en: "Resend verification email", ja: "確認メールを再送信" },
    resending: { en: "Sending…", ja: "送信中…" },
    resendError: { en: "Failed to send", ja: "送信に失敗しました" },
  },
  attendeeTable: {
    ...
    selectRow: { en: "Select {name}", ja: "{name} を選択" },
    bulkMarkPresent: { en: "Mark {count} present", ja: "{count} 名を出席にする" },
    bulkPartialError: { en: "{count} couldn't be marked present — try again.", ja: "{count} 名を出席にできませんでした。もう一度お試しください。" },
  ...
  classroomDetail: {
    ...
    deleteClassroomHint: {
      ...
      ja: "このクラスと、その名簿・セッション・出席履歴がすべて完全に削除されます。この操作は取り消せません。",
    },
    typeNameToConfirm: { en: "Type \"{name}\" to confirm", ja: "確認のため「{name}」と入力してください" },
    deleteClassroomConfirm: { en: "Permanently delete this classroom", ja: "このクラスを完全に削除する" },
    deleteClassroomError: { en: "Failed to delete classroom", ja: "クラスの削除に失敗しました" },
  ...
  settings: {
    ...
    profileError: { en: "Failed to save changes", ja: "変更の保存に失敗しました" },
    notificationsHeading: { en: "Notifications", ja: "通知" },
    emailNotificationsLabel: { en: "Email reminders & nudges", ja: "メールでのリマインダー・通知" },
    emailNotificationsHint: {
      en: "Event reminders and attendance nudges. Turning this off is the same as clicking unsubscribe in one of those emails.",
      ja: "イベントのリマインダーや出席に関する通知です。オフにすると、メール内の配信停止リンクをクリックしたのと同じ扱いになります。",
    },
    passwordHeading: { en: "Password", ja: "パスワード" },
    currentPasswordLabel: { en: "Current password", ja: "現在のパスワード" },
    newPasswordLabel: { en: "New password", ja: "新しいパスワード" },
