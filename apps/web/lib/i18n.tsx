...
const dict = {
  ...
  classroomDetail: {
    ...
    startSession: { en: "Start today's session", ja: "本日のセッションを開始" },
    endSession: { en: "End session", ja: "セッションを終了" },
    sessionOpenBadge: { en: "Session open", ja: "セッション開催中" },
    sessionStartError: { en: "Failed to start today's session", ja: "本日のセッションの開始に失敗しました" },
    ...
    noOpenSessionHint: {
      en: "No session is open right now — check back when your teacher starts today's session.",
